...
public class save_pointNET : MonoBehaviour {
	...
	public static int update_pointNET = 0;
	// Use this for initialization
	void Start () 
	{
		update_pointNET = PlayerPrefs.GetInt ("poin");
	}

	public static void simpan_skorNET(){
        point_lamaNET = potAreaNET.totalScorePoint;
        simpan_pointNET = point_lamaNET + update_pointNET;
		Debug.Log(update_pointNET + point_lamaNET);
